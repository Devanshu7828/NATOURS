      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)("error", "unable");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZHJhamFrIiwiYSI6ImNrbzg5em1lYzBpZ2wyb211bHJ1YzRucWYifQ.Ov1dMqxZgR5S2WMsvtf1TA";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/drajak/cko9oyop66a5n17qbplk4e1mi",
    scrollZoom: false
  });
...
var stripe = Stripe("pk_test_51Io00FSAn4fTk3JYZb7DxdSWDr5wHX3XbzcDKgHtj3fYyueZtkdpv0tKsY7f5QflXF1KiPWKRD3802QRD5fWNDgt00J0uq8vEJ");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2) Create checkout form + chare credit card
...
var logoutBtn = document.querySelector(".nav__el.nav--logout");
var userDataForm = document.querySelector(".form.form.form-user-data");
...
if (userDataForm) {
  userDataForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSetting.updateSetings)(form, "data");
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              e.preventDefault();
              _context.next = 8;
              return (0, _updateSetting.updateSetings)({
